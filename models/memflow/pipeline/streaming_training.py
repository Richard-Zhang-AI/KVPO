...
from models.memflow.utils.wan_wrapper import WanDiffusionWrapper
from models.memflow.utils.scheduler import SchedulerInterface
from typing import List, Optional, Tuple
import torch
import torch.distributed as dist
from models.memflow.utils.debug_option import DEBUG, LOG_GPU_MEMORY
from models.memflow.utils.memory import log_gpu_memory
...
class StreamingTrainingPipeline:
    ...
    def _maybe_latent_noise_inject(
        ...
        """Hook called before each denoising forward; override for noise-diversity experiments."""
        return noisy_input
        ...
        *,
        ...
        for block_index, current_num_frames in enumerate(all_num_frames):
            ...
            for step_idx, current_timestep in enumerate(self.denoising_step_list):
                ...
                noisy_input = self._maybe_latent_noise_inject(noisy_input, block_index, step_idx)
